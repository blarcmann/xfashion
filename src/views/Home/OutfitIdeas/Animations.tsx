...
import Animated, { add, block, call, cond, eq, set, spring, startClock, stopClock } from "react-native-reanimated"
...
export const useSpring = ({
  value, velocity, state: gestureState, snapPoints, onSnap, }: WithSpringParams
) => {
